    ...
    <ul class="navbar-nav">
     ...
     <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/online/onlinepaymenthistory">Online Payments Summary <span class="sr-only">(current)</span></a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <?php echo form_open('online/gradewisepaymentSumamry') ?>
        ...
        <div class="row">
            <div class="col table-responsive" style="overflow-x: auto; max-width: 100%; height: 450px; overflow-y: auto;">
                ...
                if (isset($students) && is_array($students)) { 
                  $branch = 'ONL';
                  ?>
                <h2 class="text-center"><?php echo urldecode($pclass_name); ?></h2>
                ...
                <div class="tab-content" id="nav-tabContent">
                  ...
                  foreach ($students as $subjectName => $subjectsdata) {
                    // print subject name as tab content
