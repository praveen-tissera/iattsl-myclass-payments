    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                ?>
                <h1 class="text-center display-4" style="font-size:3rem">Select Subject</h1>
                ...
                <?php echo form_open('mark/students') ?>
                <table class="table table-borderless">
                    <tr>
                        ...
                        <div class="form-group">
                          ...
                          <input type="email" class="form-control" id="selectclass" readonly value="<?php echo $class_name; ?>" name="selectclass">
                        </div>
                        <div class="form-group">
